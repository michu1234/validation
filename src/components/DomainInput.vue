<template>
  ...
  <div id='domainInput'>
    ...
    <p class="domainInput__description">Your Organization's
      <span>domain</span> will be your home address.</p>
    <form action="">
      <div class="input--wrapper">
        <input @keypress="validate" v-model="domain" :class="{'input--long': true, 'input--error': !valid && domain !== ''}" type="text"
